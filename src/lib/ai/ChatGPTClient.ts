...
||>Title:`,
  ...
  async sendMessage(
    ...
    let conversation: Conversation = typeof opts.conversation === 'object'
      ? opts.conversation
  ...
  async buildPrompt(messages: MyChatMessage[], parentMessageId: string, {isChatGptModel = false, promptPrefix = null}) {
